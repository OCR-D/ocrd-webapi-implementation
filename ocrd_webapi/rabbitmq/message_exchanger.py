...
class MessageExchanger:
    ...
    def __set_connection_parameters(self):
        connection_parameters = pika.ConnectionParameters(
            ...
            # TODO: The heartbeat must not be disabled(0) in production!
            heartbeat=0
        )
    ...
    def configure_default_queue(self):
        # Declare the queue to which the data is pushed
        self.declare_queue(DEFAULT_QUEUE)
        # Bind the queue to the Exchanger agent
        self.bind_queue(DEFAULT_QUEUE)
