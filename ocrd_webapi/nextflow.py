...
class NextflowExecutor:
    def __init__(self):
        ...
        self.nf_version = self._is_nf_available()
    ...
    def execute_workflow(self, nf_script_path, workspace_path, job_dir):
        nf_command = self._build_nf_command(nf_script_path, workspace_path)
    ...
    def _is_nf_available(self):
        ...
        nf_version = self._parse_nf_version(ver_process.stdout)

        return nf_version
    def _parse_nf_version(self, version_string):
        ...
        return None
    def _build_nf_command(self, nf_script_path, workspace_path):
